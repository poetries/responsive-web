...
(function($) {
    ...
    var create_rules_group_tools = function(container_id) {
        ...
        tools_html += '<select id="' + group_tools_id + '" class="' + rulesGroupToolsListClass + ' hide">';
        ...
        // damon added
        tools_html += '<a href="javascript:;" onclick="$(\'#'+ group_tools_id +'\').val(\'rule_insert_inside\').trigger(\'change\');return false;"><i class="fa fa-plus-circle" title="'+ rsc_jui_fr.rule_insert_inside +'"></i></a>';
    ...
    var create_rule_tools = function(container_id) {
        ...
        // edit by damon 20151117，将select简化为操作链接
        tools_html += '<a href="javascript:;" value="rule_delete" title="'+ rsc_jui_fr.rule_delete +'" onclick="$(\'#'+rule_tools_id+'\').val(\'rule_delete\').trigger(\'change\');return false;"><i class="fa fa-remove"></i></a>';
        // tools_html += '<a href="javascript:;" value="rule_insert_after"><i class="fa fa-plus-circle"></i></a>';
        // edit end   
        
        tools_html += '<select id="' + rule_tools_id + '" class="hide ' + ruleToolsClass + '">';
