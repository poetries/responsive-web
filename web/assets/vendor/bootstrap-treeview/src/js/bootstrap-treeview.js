	...
	*/
	...
	Tree.prototype.setExpandedState = function (node, state, silent) {
		...
		if (state) {
			...
			node.state.expanded = true;
			if (!silent) {
				this.$element.addClass('third_level').trigger('nodeExpanded', $.extend(true, {}, node));
			}
		}
		else {
			...
			node.state.expanded = false;
			if (!silent) {
				this.$element.removeClass('third_level').trigger('nodeCollapsed', $.extend(true, {}, node));
			}
		}
	};
	...
	Tree.prototype.buildTree = function (nodes, level) {
		...
		$.each(nodes, function addNodes(id, node) {
			...
			var treeItem = $(_this.template.item)
				...
				.addClass(node.state.selected ? 'active' : '')
				.addClass(node.active ? 'active' : '')
	...
	Tree.prototype.template = {
		list: '<ul class="list-group nav navbar navbar-default nav-side"></ul>',
		item: '<li class="list-group-item"></li>',
		indent: '<span class="indent"></span>',
		expandCollapseIcon: '<span class="expand-collapse none"></span>',
		icon: '<span class="icon none"></span>',
		link: '<a href="#"></a>',
